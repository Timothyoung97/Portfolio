    ...
    return (
        <Layout title="Peter Griffin Task Tracker">
            <Container>
                ...
                <P>
                    A simple "Family Guy" themed to-do list application developed using Java and JavaFX. You can set tasks with deadlines, timing specific events or simply to-dos to complete.
                </P>
                <List ml={4} my={4}>
                    <ListItem>
                        <Meta>Language</Meta>
